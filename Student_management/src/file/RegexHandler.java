...
public class RegexHandler {
    private static final String REGEX_STUDENT_CODE = "^ST-[0-9]{4}$";
    ...
    private static final String REGEX_SUBJECT_CODE = "^S-[0-9]{4}$";
    private static final String REGEX_CREDITS = "[0-10]$";
